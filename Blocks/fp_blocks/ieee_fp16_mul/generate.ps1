...
try {
  if (Get-Command sbt -ErrorAction SilentlyContinue) {
    sbt "runMain hardfloat.Emitieee_fp16_mul ../../fp_blocks/ieee_fp16_mul/rtl"
  } elseif (Test-Path "sbt-launch.jar") {
    java -jar sbt-launch.jar "runMain hardfloat.Emitieee_fp16_mul ../../fp_blocks/ieee_fp16_mul/rtl"
  } else {
